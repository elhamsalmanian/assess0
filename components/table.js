      ...
      <span
        className={
          classNames(
            ...
            status.startsWith("running") ? "bg-blue-100 text-blue-800" : null,
            status.startsWith("failed") ? "bg-red-100 text-red-800" : null,
            status.startsWith("canceled") ? "bg-yellow-100 text-yellow-800" : null,
    ...
    return (
      <div className="flex items-center">
        <div className="flex-shrink-0 h-10 w-10">
          <Image className="rounded-full" src={row.original[column.imgAccessor]} alt=""  width={40} height={35} />
        </div>
        <div className="ml-4">
